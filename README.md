<div class="cover">
<div align="center">
<img src="./assets/img/introduction/logo-upc.png" alt="Logo-UPC" width="150">
...
- [Capítulo IV: Solution Software Design](docs/chapter-IV.md#capítulo-iv-solution-software-design)
    ...
    - [4.2. Tactical-Level Domain-Driven Design](docs/chapter-IV.md#42-tactical-level-domain-driven-design)
        ...
        - [4.2.x.5. Bounded Context Software Architecture Component Level Diagrams](docs/chapter-IV.md#42x5-bounded-context-software-architecture-component-level-diagrams)
        - [4.2.x.6. Bounded Context Software Architecture Code Level Diagrams](docs/chapter-IV.md#42x6-bounded-context-software-architecture-code-level-diagrams)
        - [4.2.x.6.1. Bounded Context Domain Layer Class Diagrams](docs/chapter-IV.md#42x61-bounded-context-domain-layer-class-diagrams)
        - [4.2.x.6.2. Bounded Context Database Design Diagram](docs/chapter-IV.md#42x62-bounded-context-database-design-diagram)
